...
export declare function createGrayscalePNGXObject(data: png.PNGData): PDFStreamObject;
export declare function createTruecolorPNGXObject(data: png.PNGData): PDFStreamObject;
export declare function createIndexedPNGXObject(data: png.PNGData): PDFStreamObject;
export declare function createPNGXObject(data: png.PNGData): PDFStreamObject;
