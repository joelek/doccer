...
wtf.test(`BoxNode should support height "extrinsic".`, (assert) => {
    let node = new box_1.BoxNode({ height: "extrinsic" });
    let atoms = node.createSegments({ w: 0, h: 10 }, { w: 0, h: Infinity });
    assert.equals(atoms, [
        {
            "size": {
...
wtf.test(`BoxNode should support overflow "hidden".`, (assert) => {
    let node = new box_1.BoxNode({ overflow: "hidden" });
    let atoms = node.createSegments({ w: 0, h: 0 }, { w: 0, h: Infinity });
    assert.equals(atoms, [
        {
            "size": {
...
wtf.test(`BoxNode should support overflow "visible".`, (assert) => {
    let node = new box_1.BoxNode({ overflow: "visible" });
    let atoms = node.createSegments({ w: 0, h: 0 }, { w: 0, h: Infinity });
    assert.equals(atoms, [
        {
            "size": {
...
wtf.test(`BoxNode should support segmentation_threshold 0 when height used is 0%.`, (assert) => {
    let node = new box_1.BoxNode({ segmentation_threshold: 0 });
...
wtf.test(`BoxNode should support segmentation_threshold 1 when height used is 0%.`, (assert) => {
    let node = new box_1.BoxNode({ segmentation_threshold: 1 });
    let atoms = node.createSegments({ w: 0, h: 10 }, { w: 0, h: 10 });
    assert.equals(atoms, [
        {
            "size": {
...
wtf.test(`BoxNode should support width.`, (assert) => {
    let node = new box_1.BoxNode({ width: 10 });
    let atoms = node.createSegments({ w: 0, h: 0 }, { w: 0, h: Infinity });
    assert.equals(atoms, [
        {
            "size": {
...
wtf.test(`BoxNode should support width "extrinsic".`, (assert) => {
    let node = new box_1.BoxNode({ width: "extrinsic" });
    let atoms = node.createSegments({ w: 10, h: 0 }, { w: 0, h: Infinity });
    assert.equals(atoms, [
        {
            "size": {
