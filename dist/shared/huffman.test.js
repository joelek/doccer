...
wtf.test(`HuffmanRecord should decode symbols using a BistreamReaderMSB.`, (assert) => {
    let bsr = new bitstreams_1.BitstreamReaderMSB(Uint8Array.of(0b010_011_10, 0b0_101_110_0, 0b0_1110_111, 0b1_0000000));
...
wtf.test(`HuffmanRecord should decode symbols using a BistreamReaderLSB.`, (assert) => {
    let bsr = new bitstreams_1.BitstreamReaderLSB(Uint8Array.of(0b01_110_010, 0b0_011_101_0, 0b111_0111_0, 0b0000000_1));
